...
/*define icon*/
    const unsigned char cloud [4][8] = {
			{0x0F, 0x09, 0x08, 0xE9, 0xAF, 0xE0, 0x00, 0x00}, // độ C : 1
			{0x7C, 0XFE, 0XFE, 0XBE, 0x5C, 0x28, 0X10, 0X00}, //giọt nước : 2
			{0xFF, 0x81, 0x95, 0xA1, 0x81, 0xFF, 0x81, 0xFF}, //calendar : 3
			{0x3C, 0x7E, 0xE3, 0xEF, 0xEF, 0xEF, 0x7E, 0x3C}, //clock : 4
    };
